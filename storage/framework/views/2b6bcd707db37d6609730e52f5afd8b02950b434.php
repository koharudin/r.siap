<div class="box box-default">
    ...
    <div class="box-body">
        <form id="form-search" action="" class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control" name="unitkerja" id="unitkerja">
                        ...
                        <option value="16">16 - Kepala Sub Bagian Tata Usaha Pusat Pendidikan dan Pelatihan
                            Kearsipan</option>
                        ...
                        <option value="101">101 - Kepala Sub Bagian Tata Usaha Balai Arsip Statis dan Tsunami Aceh
                        </option>
                        ...
                        <option value="136">136 - Kepala Sub Bagian Umum Pusat Studi Arsip Statis Kepresidenan
                        </option>
                        <option value="81">81 - Kepala Bagian Perlengkapan, Tata Usaha, Kearsipan, dan Protokol
                        </option>
                        ...
                        <option value="112">112 - Kepala Sub Bagian Tata Usaha Deputi Bidang Pembinaan Kearsipan
                        </option>
                        <option value="127">127 - Kepala Sub Bagian Tata Usaha Deputi Bidang Konservasi Arsip
                        </option>
                        <option value="134">134 - Kepala Sub Bagian Tata Usaha Deputi Bidang Informasi dan
                            Pengembangan Sistem Kearsipan</option>
                    </select>
                </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-12">
                <button type="submit" class="btn btn-primary">Cari</button>&nbsp;<a href="jabatan_tidaksesuaiabk"
                    class="btn btn-primary" target="_blank">Data Tidak Sesuai ABK</a>
            </div>
        </form>
                ...
                <thead>
                    <tr>
                        <th colspan="9">Petunjuk:<br />
                            ...
                            2. Gunakan tombol Sinkron Data untuk menghitung/meng-update Existing Pegawai dan
                            Kelebihan/Kekurangan.</br>
                            3. Bulan Tahun adalah Periode ABK yang diinput ke dalam sistem.
                        </th>
                        <th style="text-align:right;"><button type="submit" class="btn btn-primary" name="sinkron"
                                id="sinkron" onclick="SinkronData()">Sinkron Data</button><br></th>
                    </tr>
                    <tr>
                        <th>Unit Kerja</th>
                        <th>Bulan</th>
                ...
                },
                {
                    ...
                    render: function(data, type, full) {
                        ...
                        if (full.url_existing[0] == 0) {
                            ...
                            actions.push("<a href='existing_pegawai?unit_id=" + full
                                .url_existing[1] + "&jabatan=" + full.url_existing[2] +
                                "' target='_blank' >Lihat Pegawai</a>");
                        }
                        return actions.join('');
                    }
                },
                ...
                },
                {
                    ...
                    render: function(data, type, full) {
                        ...
                        if (full.aksi[0] > full.aksi[1]) {
                            actions.push(
                                "<span class='badge badge-pill' style='background-color:#ffc107;padding:5px;'>Kurang dari ABK</span>"
                                );
                        } else if (full.aksi[0] < full.aksi[1]) {
                            actions.push(
                                "<span class='badge badge-pill' style='background-color:#dc3545;padding:5px;'>Lebih dari ABK</span>"
                                );
                        } else {
                            actions.push(
                                "<span class='badge badge-pill' style='background-color:#28a745;padding:5px;'>Sesuai ABK</span>"
                                );
                        }
                        return actions.join('');
                    }
...
<?php /**PATH /home/webapps/anri.siap/resources/views/v_penempatan_pegawai.blade.php ENDPATH**/ ?>