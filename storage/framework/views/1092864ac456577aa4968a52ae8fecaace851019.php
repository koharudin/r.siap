<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <script>
            var sessionData = <?php echo json_encode(Auth::user()->roles[0]['id']); ?>;
            console.log(sessionData);
        </script>
        <form class="sidebar-form" style="overflow: initial;" onsubmit="return false;">
            <div class="input-group">
                <input type="text" autocomplete="off" class="form-control autocomplete" placeholder="Cari Pegawai...">
              <span class="input-group-btn">
                <button type="submit" name="search" id="search-btn" class="btn btn-flat"><i class="fa fa-search"></i>
                </button>
              </span>
                <ul class="dropdown-menu" role="menu" style="min-width: 210px;max-height: 300px;overflow: auto;font-color: black;">
                    ...
                    <li>
                        <a href="<?php echo e(admin_url("profile/{$link->id}/data_personal"), false); ?>"><?php echo e($link->first_name, false); ?> - <?php echo e($link->nip_baru, false); ?></a>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH /home/webapps/anri.siap/vendor/encore/laravel-admin/src/../resources/views/partials/sidebar.blade.php ENDPATH**/ ?>