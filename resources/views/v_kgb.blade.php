<div class="box box-default">
    <div class="box-header with-border">
        <h3 class="box-title">Kenaikan Gaji Berkala</h3>
    ...
    <!-- /.box-header -->
    <div class="box-body">
        <form id="form-search-kgb" class="form-horizontal">
                    ...
                    <div class="box-body">
                        <div class="fields-group">
                            ...
                            <div class="form-group  ">
                                ...
                                <label for="tmt_eselon" class="col-sm-2  control-label">Periode KGB</label>
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="periode_kgb" name="periode_kgb" value="<?php

                                                                                                        use Carbon\Carbon;

                                                                                                        echo Carbon::now()->format('Y/m/d'); ?>" class="form-control" placeholder="Masukan Periode KGB">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("[name=btn-cetak-kgb]").click(function() {
                var base_url = "<?php echo $url_cetak; ?>";
                window.open(base_url + "?" + $("#form-search-kgb").serialize(), '_blank');
            });
            $("#form-search-kgb").submit((function(e) {
                table.ajax.reload();
                e.preventDefault();
            }));
            var table = $('.yajra-datatable').DataTable({
                ...
                "ajax": {
                    'type': 'POST',
                    'url': "{{route('admin.kgb.dt')}}",
                    "data": function(d) {
                        d.extra_search = $('#form-search-kgb').serializeArray();
                        d._token = "{{ csrf_token() }}";
                    },
                },
                columns: [{
