...
class RiwayatMertuaController extends Controller
{
    /**
    ...
    public function index()
    {
        //
        $user = Auth::user();
        $employee = Employee::with(['obj_riwayat_mertua'])->whereRaw('nip_baru = ?',[$user->username])->first();
        return response()->json($employee->obj_riwayat_mertua()->paginate());
    }
