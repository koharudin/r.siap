...
class FormMPP2TUSK extends Form
{
    protected $employee;
    ...
    public function handle(Request $request)
    {
        ...
        $e->obj_riwayat_pensiun->mpp = null;
        $e->obj_riwayat_pensiun->tusk = "v";
        $e->obj_riwayat_pensiun->tgl_bkn = $request->tgl_bkn;
        $e->obj_riwayat_pensiun->no_bkn = $request->no_bkn;
        $e->obj_riwayat_pensiun->save();
        admin_success("Pegawai [{$e->nip_baru}] ".$e->first_name." berhasil dipindahkan ke TUSK");
